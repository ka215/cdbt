...
　 _[[cdbt-view table="{string}" bootstrap_style="{boolean}" display_title="{boolean}" display_search="{boolean}" display_list_num="{boolean}" exclude_cols="{string[,string,...]}" add_class="{string[ string...]}" ]]_
...
```
[[cdbt-view table="sample_table" bootstrap_style="false" display_title="false" display_search="false" display_list_num="false" exclude_cols="created,updated" add_class="my-list-style"]]
```
...
### [[cdbt-edit]]
　 _[[cdbt-edit table="{string}" entry_page="{mixed(int|string)}" bootstrap_style="{boolean}" display_title="{boolean}" exclude_cols="{string[,string,...]}" add_class="{string[ string...]}"]]_
...
```
[[cdbt-edit table="sample_table" entry_page="6" bootstrap_style="false" display_title="false" display_list_num="false" exclude_cols="ID,updated" add_class="my-edit-style"]]
```
