...
$api_url_format = sprintf('<code class="raw-api-url">%s/?cdbt_api_key=&lt;%s&gt;&amp;cdbt_table=&lt;%s&gt;&amp;cdbt_api_request=&lt;%s&gt;&amp;&lt;%s&gt;=&lt;%s&gt;&amp;...</code>', get_option('siteurl'), __('API key', CDBT_PLUGIN_SLUG), __('Table name', CDBT_PLUGIN_SLUG), __('Request method name', CDBT_PLUGIN_SLUG), __('Parameter name', CDBT_PLUGIN_SLUG), __('Parameter value', CDBT_PLUGIN_SLUG));
$api_url_example = sprintf('<code class="raw-api-url">%s/?cdbt_api_key=&lt;%s&gt;&amp;cdbt_table=sample_table&amp;cdbt_api_request=get_data&amp;order={created:desc}&#010;&amp;limit=5</code>', get_option('siteurl'), __('API key', CDBT_PLUGIN_SLUG));
