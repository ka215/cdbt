...
?>
  ...
  <div class="cdbt-regist-shortcode">
    <form method="post" action="<?php echo esc_url(add_query_arg([ 'page' => $this->query['page'] ])); ?>" class="form-horizontal">
      ...
      <div class="form-group switching-item on-v">
        <label for="create-table-thumbnail_width" class="col-sm-2 control-label"><?php _e('Thumbnail width', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="spinbox disits-3" data-initialize="spinbox" id="create-table-thumbnail_width">
      ...
      </div><!-- /create-table-thumbnail_width [v] -->
      <div class="form-group switching-item on-v on-e">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <button type="button" class="btn btn-default"><?php _e('Preview Shortcode', CDBT); ?></button>
        </div>
      </div>
