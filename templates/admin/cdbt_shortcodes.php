...
<?php if ($current_tab == 'shortcode_regist') : 
  /**
   * Define the localized variables for tab of `shortcode_regist`
   */
...
?>
  ...
  <div class="cdbt-regist-shortcode">
    <form method="post" action="<?php echo esc_url(add_query_arg([ 'page' => $this->query['page'] ])); ?>" class="form-horizontal">
      ...
      </div><!-- /regist-shortcode-base_name -->
      <div class="form-group">
      ...
      <div class="form-group toggle-group">
        <label for="regist-shortcode-look_feel" class="col-sm-2 control-label"><?php _e('Toggle of look and feel', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="checkbox switching-item on-v on-i on-e" id="regist-shortcode-look_feel1"><!-- bootstrap_style [v,i,e] -->
          ...
          <div class="checkbox switching-item on-v on-e" id="regist-shortcode-look_feel2"><!-- display_list_num [v,e] -->
            <label class="checkbox-custom" data-initialize="checkbox">
          ...
          <div class="checkbox switching-item on-v" id="regist-shortcode-look_feel3"><!-- display_search [v] -->
            <label class="checkbox-custom" data-initialize="checkbox">
          ...
          <div class="checkbox switching-item on-v on-i on-e" id="regist-shortcode-look_feel4"><!-- display_title [v,i,e] -->
            <label class="checkbox-custom" data-initialize="checkbox">
          ...
          <div class="checkbox switching-item on-v on-e" id="regist-shortcode-look_feel5"><!-- enable_sort [v,e] -->
            <label class="checkbox-custom" data-initialize="checkbox">
          ...
          <div class="checkbox switching-item on-v" id="regist-shortcode-look_feel6"><!-- display_index_row [v] -->
            <label class="checkbox-custom" data-initialize="checkbox">
      ...
      <div class="form-group switching-item on-v on-e">
        ...
        <div class="col-sm-9">
          <input id="regist-shortcode-exclude_cols" name="<?php echo $this->domain_name; ?>[exclude_cols]" type="text" value="<?php if (isset($this_tab_vars['exclude_cols'])) echo $this_tab_vars['exclude_cols']; ?>" class="form-control" placeholder="col1,col2,col3,...">
      ...
      <div class="form-group switching-item on-v on-i on-e">
        ...
        <div class="col-sm-7">
          <input id="regist-shortcode-add_class" name="<?php echo $this->domain_name; ?>[add_class]" type="text" value="<?php if (isset($this_tab_vars['add_class'])) echo $this_tab_vars['add_class']; ?>" class="form-control" placeholder="class1 class2 class3 ...">
      ...
      <div class="form-group switching-item on-v">
        ...
        <div class="col-sm-9">
          <input id="regist-shortcode-narrow_keyword" name="<?php echo $this->domain_name; ?>[narrow_keyword]" type="text" value="<?php if (isset($this_tab_vars['narrow_keyword'])) echo $this_tab_vars['narrow_keyword']; ?>" class="form-control" placeholder="keyword1,keyword2,... or col1:keyword1,col2:keyword2,...">
      ...
      <div class="form-group switching-item on-i">
        ...
        <div class="col-sm-9">
          <input id="regist-shortcode-hidden_cols" name="<?php echo $this->domain_name; ?>[hidden_cols]" type="text" value="<?php if (isset($this_tab_vars['hidden_cols'])) echo $this_tab_vars['hidden_cols']; ?>" class="form-control" placeholder="col1,col2,col3,...">
          <p class="help-block"><?php _e('String as array (not assoc); For example `col1,col2,col3,...`', CDBT); ?></p>
        </div>
      ...
      <div class="form-group switching-item on-v">
        ...
        <div class="col-sm-9">
          <input id="regist-shortcode-display_cols" name="<?php echo $this->domain_name; ?>[display_cols]" type="text" value="<?php if (isset($this_tab_vars['display_cols'])) echo $this_tab_vars['display_cols']; ?>" class="form-control" placeholder="col1,col2,col3,...">
      ...
      <div class="form-group switching-item on-v">
        ...
        <div class="col-sm-9">
          <input id="regist-shortcode-order_cols" name="<?php echo $this->domain_name; ?>[order_cols]" type="text" value="<?php if (isset($this_tab_vars['order_cols'])) echo $this_tab_vars['order_cols']; ?>" class="form-control" placeholder="col1,col2,col3,...">
      ...
      <div class="form-group switching-item on-v">
        ...
        <div class="col-sm-9">
          <input id="regist-shortcode-sort_order" name="<?php echo $this->domain_name; ?>[sort_order]" type="text" value="<?php if (isset($this_tab_vars['sort_order'])) : echo $this_tab_vars['sort_order']; else : echo 'created:desc'; endif; ?>" class="form-control" placeholder="updated:desc,ID:asc,...">
          <p class="help-block"><?php _e('String as hash for example `updated:desc,ID:asc,...`', CDBT); ?></p>
        </div>
      </div><!-- /regist-shortcode-sort_order [v] -->

      <div class="form-group switching-item on-v">
        <label for="regist-shortcode-limit_items" class="col-sm-2 control-label"><?php _e('Limit Items', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="spinbox disits-3" data-initialize="spinbox" id="regist-shortcode-limit_items">
      ...
      </div><!-- /regist-shortcode-limit_items [v] -->
      ...
      <div class="form-group switching-item on-v on-e">
        <label for="regist-shortcode-display_filter" class="col-sm-2 control-label"><?php _e('Display filter', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="checkbox" id="regist-shortcode-display_filter">
            <label class="checkbox-custom" data-initialize="checkbox">
      ...
      </div><!-- regist-shortcode-display_filter [v,e] -->
      <div class="form-group switching-item on-v on-e">
        <label for="regist-shortcode-filters" class="col-sm-2 control-label"><?php _e('Filters definition', CDBT); ?></label>
        <div class="col-sm-9">
          <input id="regist-shortcode-filters" name="<?php echo $this->domain_name; ?>[filters]" type="text" value="<?php if (isset($this_tab_vars['filters'])) echo $this_tab_vars['filters']; ?>" class="form-control" placeholder="filter1:label1,filter2:label2,...">
          <p class="help-block"><?php _e('String as array (assoc); For example `filter1:label1,filter2:label2,...`', CDBT); ?></p>
        </div>
      </div><!-- /regist-shortcode-filters [v,e] -->
      <div class="form-group switching-item on-v">
        <label for="regist-shortcode-display_view" class="col-sm-2 control-label"><?php _e('Display view', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="checkbox" id="regist-shortcode-display_view">
            <label class="checkbox-custom" data-initialize="checkbox">
      ...
      </div><!-- regist-shortcode-display_view [v] -->
      <div class="form-group switching-item on-v">
        <label for="regist-shortcode-thumbnail_column" class="col-sm-2 control-label"><?php _e('Thumbnail column', CDBT); ?></label>
        <div class="col-sm-3">
          <input id="regist-shortcode-thumbnail_column" name="<?php echo $this->domain_name; ?>[thumbnail_column]" type="text" value="<?php if (isset($this_tab_vars['thumbnail_column'])) echo $this_tab_vars['thumbnail_column']; ?>" class="form-control" placeholder="">
        </div>
      ...
      </div><!-- /regist-shortcode-thumbnail_column [v] -->
      <div class="form-group switching-item on-v">
        <label for="regist-shortcode-thumbnail_title_column" class="col-sm-2 control-label"><?php _e('Thumbnail title column', CDBT); ?></label>
        <div class="col-sm-3">
          <input id="regist-shortcode-thumbnail_title_column" name="<?php echo $this->domain_name; ?>[thumbnail_title_column]" type="text" value="<?php if (isset($this_tab_vars['thumbnail_title_column'])) echo $this_tab_vars['thumbnail_title_column']; ?>" class="form-control" placeholder="">
        </div>
        <p class="help-block col-sm-offset-2 col-sm-9"><?php _e('Column name to be used as a thumbnail title', CDBT); ?></p>
      </div><!-- /regist-shortcode-thumbnail_title_column [v] -->
      <div class="form-group switching-item on-v">
        <label for="regist-shortcode-thumbnail_width" class="col-sm-2 control-label"><?php _e('Thumbnail width', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="spinbox disits-3" data-initialize="spinbox" id="regist-shortcode-thumbnail_width">
      ...
      </div><!-- /regist-shortcode-thumbnail_width [v] -->
      <div class="form-group switching-item on-v on-e">
        <label for="regist-shortcode-ajax_load" class="col-sm-2 control-label"><?php _e('Ajax load', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="checkbox" id="regist-shortcode-ajax_load">
            <label class="checkbox-custom" data-initialize="checkbox">
      ...
      </div><!-- regist-shortcode-ajax_load [v,e] -->
      
      <div class="form-group switching-item on-i">
        <label for="regist-shortcode-action_url" class="col-sm-2 control-label"><?php _e('Action url', CDBT); ?></label>
        <div class="col-sm-9">
          <input id="regist-shortcode-action_url" name="<?php echo $this->domain_name; ?>[action_url]" type="text" value="<?php if (isset($this_tab_vars['action_url'])) echo $this_tab_vars['action_url']; ?>" class="form-control" placeholder="">
          <p class="help-block"><?php _e('String of url for form action [optional] For using shortcode of `cdbt-edit`', CDBT); ?></p>
        </div>
      </div><!-- /regist-shortcode-action_url [i] -->
      <div class="form-group switching-item on-i">
        <label for="regist-shortcode-form_action" class="col-sm-2 control-label"><?php _e('Render image type', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="input-group input-append dropdown combobox col-sm-3" data-initialize="combobox" id="regist-shortcode-form_action">
      ...
      </div><!-- /regist-shortcode-display_submit [i] -->
      <div class="form-group switching-item on-i">
        <label for="regist-shortcode-display_submit" class="col-sm-2 control-label"><?php _e('Display submit', CDBT); ?></label>
        <div class="col-sm-10">
          <div class="checkbox" id="regist-shortcode-display_submit">
            <label class="checkbox-custom" data-initialize="checkbox">
      ...
      <div class="form-group switching-item on-i">
        <label for="regist-shortcode-where_clause" class="col-sm-2 control-label"><?php _e('Where clause', CDBT); ?></label>
        <div class="col-sm-9">
          <input id="regist-shortcode-where_clause" name="<?php echo $this->domain_name; ?>[where_clause]" type="text" value="<?php if (isset($this_tab_vars['where_clause'])) echo $this_tab_vars['where_clause']; ?>" class="form-control" placeholder="col1:value1,col2:value2,...">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <textarea id="regist-shortcode-generate_shortcode" name="<?php echo $this->domain_name; ?>[generate_shortcode]" class="form-control" rows="5" readonly><?php if (isset($this_tab_vars['generate_shortcode'])) echo esc_textarea(stripslashes_deep($this_tab_vars['generate_shortcode'])); ?></textarea>
        </div>
      </div>
      <div class="form-group">
        <label for="regist-shortcode-alias_code" class="col-sm-2 control-label"><?php _e('Alias Shortcode', CDBT); ?></label>
        <div class="col-sm-9">
          <input id="regist-shortcode-alias_code" name="<?php echo $this->domain_name; ?>[alias_code]" type="text" value="<?php if (isset($this_tab_vars['alias_code'])) echo esc_textarea(stripslashes_deep($this_tab_vars['alias_code'])); ?>" class="form-control" readonly>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <button type="button" class="btn btn-default" id="regist-shortcode-preview"><?php _e('Preview Shortcode', CDBT); ?></button>
        </div>
      </div>
