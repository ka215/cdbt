...
<div class="wrap">
  ...
  $step1_content .= __('However, it is not yet in the release version.<br>Degree of completion of the current CDBT V2 is about <strong style="font-size: 32px;">70%</strong>.<br>Please wait for until complete.', CDBT);
  $step1_content .= '</p>';
