    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <div class="input-group col-sm-3 pull-left">
          <input class="form-control text-center" id="entry-data-<?php esc_attr_e($element['elementName']); ?>-date" type="text" value="">
        ...
        <div class="col-sm-2 pull-left">
          <div class="input-group input-append dropdown combobox" data-initialize="combobox">
            <input type="text"  id="entry-data-<?php esc_attr_e($element['elementName']); ?>-hour" value="" class="form-control text-center">
            <div class="input-group-btn">
...
datepicker['<?php esc_attr_e($element['elementName']); ?>'] = function() {
  $('#entry-data-<?php esc_attr_e($element['elementName']); ?>-date').datepicker('setDate', new Date());
};
</script>
<?php
        break;
